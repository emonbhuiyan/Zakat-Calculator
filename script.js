    ...
    document.getElementById("result").innerHTML = `
        <div class="alert alert-success">
            ...
            <div class="alert alert-primary mt-3">
                <i class="fas fa-balance-scale"></i> Total Pure Gold Weight: <strong>${totalPureGoldWeight.toFixed(2)}g</strong>
                <i class="fas fa-gem"></i> Zakatable Gold Weight: <strong>${totalZakatableGoldWeight.toFixed(2)}g</strong>
            </div>
            <div class="alert alert-secondary mt-3">
                <i class="fas fa-balance-scale-right"></i> Total Silver Weight: <strong>${totalSilverWeight.toFixed(2)}g</strong>
                <i class="fas fa-coins"></i> Zakatable Silver Weight: <strong>${totalZakatableSilverWeight.toFixed(2)}g</strong>
            </div>
